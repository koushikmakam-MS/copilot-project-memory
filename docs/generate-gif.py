...
lines.append(("", FG))
lines.append(("  VERIFY: pipeline verify --step step-1", YELLOW))
...
lines.append(("  VERIFY: pipeline verify --step step-2", YELLOW))
...
lines.append(("  VERIFY: pipeline verify --step step-3", YELLOW))
...
lines_page2.append(("  VERIFY: pipeline verify --step step-4", YELLOW))
...
lines_page2.append(("=" * 60, PURPLE))
lines_page2.append(("", FG))
lines_page2.append(("  4a: pipeline verify plan.yaml", YELLOW))
...
fail_lines.append(("  VERIFY: pipeline verify --step step-2", YELLOW))
